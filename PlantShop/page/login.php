...
<body>
  <div class="login">
    ...
    <form class="login-container" action="login.php" method="post">
      ...
      <p>
        <input type="text" name="username" placeholder="Username" value="Aldo" required>
      </p>
      <p>
        <input type="password" name="password" placeholder="Password" value="aldo" required>
      </p>
      <p>
      ...
      <br>
      <center>
        <p>Repost by <a href="instagram.com/ryzhldo.png" title="Connect with me" target="_blank">instagram.com/ryzhldo.png</a></p>
      </center>
